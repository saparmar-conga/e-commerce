            ...
            <li>
              <div class="form-check">
                <input
                  ...
                  checked
                >
                <label class="form-check-label pt-1" for="all">
            ...
            <li class="pt-1">
              <div class="form-check">
                <input
                  ...
                  (change)="handleCheckChange($event)"
                >
                <label class="form-check-label pt-1" for="less30">
            ...
            <li class="pt-1">
              <div class="form-check">
                <input
                  ...
                  (change)="handleCheckChange($event)"
                >
                  <label class="form-check-label pt-1" for="30-60">
            ...
            <li class="pt-1">
              <div class="form-check">
                <input
                  ...
                  (change)="handleCheckChange($event)"
                >
                <label class="form-check-label pt-1" for="60-90">
            ...
            <li class="pt-1">
              <div class="form-check">
                <input
                  ...
                  (change)="handleCheckChange($event)"
                >
                <label class="form-check-label pt-1" for="more90">
