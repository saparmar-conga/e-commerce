        ...
        <ul class="list-unstyled ps-2">
          <li>
            <div class="form-check">
              ...
              >
              <label class="form-check-label pt-1" for="assetActionAll">
          ...
          <li class="pt-1">
            <div class="form-check">
              <input
                ...
                [checked]="value === 'Renew'"
              >
              <label class="form-check-label pt-1" for="renew">
          ...
          <li class="pt-1">
            <div class="form-check">
              <input
                ...
                [checked]="value === 'Amend'"
              >
              <label class="form-check-label pt-1" for="amend">
          ...
          <li class="pt-1">
            <div class="form-check">
              ...
              <label class="form-check-label pt-1" for="terminate">
          ...
          <li class="pt-1">
            <div class="form-check">
              ...
              <label class="form-check-label pt-1" for="buyMore">
